...
namespace cowsins2D
{
    public class CameraController : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("Camera position variation")] private Vector2 cameraOffset;
        ...
        private void SimpleFollowTarget() => transform.position = Vector3.Lerp(transform.position, target.position + offset + (Vector3)cameraOffset, Time.deltaTime * 1 / cameraLaziness);
