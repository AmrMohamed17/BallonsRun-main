...
namespace cowsins2D
{
    public class Crosshair : MonoBehaviour
    {
        ...
        private void Awake()
        {
            if (Crosshair.Instance == null) Crosshair.Instance = this;
        ...
        private void Update()
        {
            ...
            if (DeviceDetection.Instance.mode == DeviceDetection.InputMode.Controller && PlayerStats.controllable) Hide(false);
            else Show();
        }
        ...
        public void CheckIfCanShow()
        {
            if (!showCrosshairIfWeaponIsNull && player.weapon == null) return;
            hidden = false;
            Cursor.visible = false;
        }
    }
