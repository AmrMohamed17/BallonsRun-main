...
namespace cowsins2D
{
    public class EnemyHealth : MonoBehaviour, IDamageable
    {
        ...
        [SerializeField, Tooltip("Array that contains all the spriteRenderers that will blink on damage. These must have the Blink material assigned.")] protected Renderer[] graphics;
