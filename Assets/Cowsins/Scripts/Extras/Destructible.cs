...
namespace cowsins2D
{
    ...
    {
        [SerializeField, Tooltip("Elements instantiated on destroying the object, more likely to be used to display broken elements of the object.")] private GameObject destroyedGraphics;
